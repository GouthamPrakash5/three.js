function Strings( config ) {
	...
	const values = {
		...
		en: {
			...
			'menubar/run': 'Run',
			'menubar/run/run program': 'Run Program',
			...
			'sidebar/geometry/cylinder_geometry/thetastart': 'Theta start',
			'sidebar/geometry/cylinder_geometry/thetalength': 'Theta length',
